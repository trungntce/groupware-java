package kr.co.hs.approval.agree.controller;
...
import kr.co.hs.approval.agree.service.ApprovalAgreeService;
...
@Controller
@RequestMapping("/approval/agree")
public class ApprovalAgreeController {
    ...
    @Autowired
    private ApprovalAgreeService approvalSelfService;
    ...
    public String goList(HttpServletRequest request, Model model, ApprovalSearchDTO searchDTO){
        searchDTO = approvalSelfService.initParam(request, searchDTO);
