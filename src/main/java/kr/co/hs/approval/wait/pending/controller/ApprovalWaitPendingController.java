package kr.co.hs.approval.wait.pending.controller;
...
@Controller
@RequestMapping("/approval/wait/pending")
public class ApprovalWaitPendingController {
    ...
    public String goList(HttpServletRequest request, Model model, ApprovalSearchDTO searchDTO){
        searchDTO = approvalWaitPendingService.initParam(request, searchDTO);
        ...
        return "/approve/wait/pending/list";
    }
    ...
    public String goDetail(Model model, ApprovalSearchDTO searchDTO){
        ...
        return "/approve/wait/pending/detail";
    }
}
