...
var App = function () {
    ...
    var handleHorizontalMenu = function () {
        ...
        $('.extra-search').on('keypress', function (e) {
            if (e.which == 13) {
                $('.form-search').submit();
                return false;
            }
    ...
    var handleBootstrapSwitch = function () {
        ...
        if (!$('.make-switch').hasClass('switch-ok')) {
            $('.make-switch').bootstrapSwitch();
            $('.make-switch').addClass('switch-ok');
        } else {
            $('.make-switch').removeClass('switch-ok');
        }
    }
    ...
    return {
        ...
        startPageLoading: function (message) {
            $('.page-loading').remove();
            $('body').append('<div class="page-loading"><img src="../../Content/themes/assets/img/loading-spinner-grey.gif"/>&nbsp;&nbsp;<span>' + (message ? message : 'Loading...') + '</span></div>');
        },
