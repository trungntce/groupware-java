...
<div id="content" class="content">
    <h3 class="page-title"><spring:message code='gallery.bigtitleedit'/> <small><spring:message code='gallery.smalltitlefree'/></small></h3>
    <!-- html -->
    <div class="row">
                ...
                <div class="panel-body">
                    <form id="myform" class="form-inline" action="">
                        <table class="table mb-0">
                            ...
                            <tr>
                                <td style="width: 15%">
                                    <button type="button" class="btn btn-success" onclick="addG()"><spring:message code='author.list.update'/></button>
        ...
        if (isValid == true) {
            if (CKEDITOR.instances['noidung'].getData().trim() != "") {
                ...
                $.ajax(settings).done(function (response) {
                    alert("Success");
                    location.href="/board/detail.hs?id=${lstDetail.id}";
                });
            } else {
