...
<div id="content" class="content">
    <h3 class="page-title">
        <spring:message code='dayproject.adddayproject.editbudget' />
        <br>
        <small>
                        ...
                        <table class="table mb-0">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="background: #f0f4f6;"><spring:message code='dayproject.adddayproject.amount' /></td>
                                    <td><input id="project_price" name="project_price" class="form-control form-control-sm mr-1" type="number" value="${lst.projectPrice}"></td>
                                </tr>
                                <tr>
                                    <td colspan="4">
...
<script>
    ...
    function editP() {
        ...
        if (isValid == true && amount > 0) {
            on();
            var settings = {
                "url": "/API/dayproject/editDepositDayProject",
                "method": "POST",
                "headers": {
