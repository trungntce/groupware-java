...
%>
        ...
        <div id="content" class="content">
            <h3 class="page-title">
                <spring:message code='dayproject.dayproject.registerspent' />
                <br>
                <small>
                            ...
                            <form id="myform" class="form-inline" action="">
                                <table class="table mb-0">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="background: #f0f4f6;"><spring:message code='dayproject.adddayproject.spentstatus' /></td>
                                            <td>${langCd=='ko' ? '예산지출': (langCd=='en' ? 'Spent':'Chi tiêu')}</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><textarea id="title" name="title" maxlength="1000" class="form-control w-100" rows="2" cols="80"></textarea></td>
                                        </tr>
                                        <tr>
                                            <td colspan="100">
                            ...
                            <form id="myform" class="form-inline" action="">
                                <table class="table mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 35%">${langCd=='ko' ? '예산지출': (langCd=='en' ? 'Spent':'Chi tiêu')}</td>

                                    </tr>
                                    <tr>
                                        <td style="background: #f0f4f6;"><spring:message code='emp.list.department' /></td>
                                        <td>${lstInfoProjectByID.deptName}</td>
