            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <table class="table mb-0" id="frmPrint">
                        ...
                        <tr>
                            <td>
                                <table class="cke-tbl-sign" border="1" style="width: unset !important;">
                                    <tbody>
                                        <tr>
                                            <td rowspan="4">
                                                Lưu trình<br>
                                        ...
                                        <tr>
                                            <c:forEach items="${empSign}" var="lst" varStatus="loop">
                                                <c:if test="${lst.approvalRole == 1 && lst.approvalStatus == 3}">
                                                    <td>${lst.deptName}</td>
                                                </c:if>
                                            </c:forEach>
                                        </tr>
                                        <tr>
                                            <c:forEach items="${empSign}" var="lst" varStatus="loop">
                                                <c:if test="${lst.approvalRole == 1 && lst.approvalStatus == 3}">
                                                    <td><div class="sign-img"><img src="${_ctx}/${lst.signatureImagePath}" style="width:80px"></div></td>
                                                </c:if>
                                            </c:forEach>
                                        </tr>
                                        <tr>
                            ...
                            <c:if test="${empSign.size() > 0}">
                                <c:forEach items="${empSign}" var="lst" varStatus="loop">
                                    <tr>
                                        <td>
                                            ${lst.empId}
                                            <div class="data-sign d-none" data-role="${lst.approvalRole}" data-sign="${lst.approvalStatus}" data-path="${lst.signatureImagePath}" data-emp="${lst.empName}" data-dept="${lst.deptName}" data-position="${lst.positionName}"></div>
                                        </td>
