...
<form:form modelAttribute="form" id="frmWrite" cssClass="form-inline" enctype="multipart/form-data">
<div id="content" class="content w-100">
    <h3 class="page-title">
        <spring:message code='common.register.title'/><br>
                    ...
                    <table class="table mb-0">
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <button type="button" class="btn btn-success btn-draft" onclick="fnSubmit(6)"><spring:message code='button.draft.title' /></button>
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    ...
                    <table id="main-sequence-emp" class="table table-bordered mt-2 mb-0">
                        ...
                        <tbody>
                            <tr><td class="text-center" colspan="3"><i class="fas fa-inbox mr-1"></i><spring:message code='main.index.datastatus' /></td></tr>
                        </tbody>
                    </table>
                </div>
            </div>
    ...
    function initModalEmpSequence(){
        if(Object.keys(empSequence.modal).length > 0){
            ...
            for(var publicCd in empSequence.modal){
                ...
                var htmlItem = `<tr emp-cd="`+publicCd+`">
                    <td>
                        ...
                        <c:forEach items="${approvalRole}" var="lst" varStatus="loop">         
                            <option value="${lst.CCodeValue}" `+ (${lst.CCodeValue} == data['role_approve'] ? "selected" : "") +`>${lst.CCodeName}</option>
                        </c:forEach>
                        </select>
                    </td>
                ...
                // $("#list-tree").jstree('select_node', 'tree-'+publicCd);
            }
        }else{
        ...
        if(Object.keys(empSequence.modal).length > 0){
            ...
            if(supportItems.length > 0){
                ...
                supportItems.forEach((el, i) => {
                    ...
                    $(".supports-sign").append(`<h4 class="float-left"><span class="badge badge-secondary">`+el.name+`</span></h4>`)
            ...
            if(viewItems.length > 0){
                ...
                viewItems.forEach((el, i) => {
                    ...
                    $(".views-sign").append(`<h4 class="float-left"><span class="badge badge-info">`+el.name+`</span></h4>`)
                    $("#main-sequence-emp tbody").append(htmlItem)
                })
            }
