...
<div id="content" class="content">
    <h3 class="page-title">
        <spring:message code='approval.modal.translation.form.title'/><br>
                        ...
                        <tbody>
                            ...
                            <c:forEach items="${list}" var="item" varStatus="loop">
                                <tr>
                                    ...
                                    <td>
                                        <a href="${_ctx}/approval/translate/wait/update.hs?approvalId=${item.approvalId}" class="btn btn-primary"><i class="fas fa-file-signature"></i></a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </c:if>
