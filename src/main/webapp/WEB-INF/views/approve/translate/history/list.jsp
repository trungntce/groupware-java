...
<div id="content" class="content">
    <h3 class="page-title">
        <spring:message code='approval.page.translate.history.title'/><br>
        ...
        <div class="col-xl-12 ui-sortable">
            <div class="panel panel-inverse" style="">
                ...
                <div class="panel-body">
                    <form id="frmSearch" name="search"  class="form-inline" action="">
                        ...
                        <tbody>
                            ...
                            <c:forEach items="${list}" var="item" varStatus="loop">
                                <tr>
                                    ...
                                    <td>
                                        <a href="${_ctx}/approval/translate/confirm/update.hs?approvalId=${item.approvalId}" class="btn btn-primary"><i class="fas fa-file-signature"></i></a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </c:if>
