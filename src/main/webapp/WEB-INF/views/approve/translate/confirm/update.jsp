...
<div id="content" class="content">
    ...
    <div class="row">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <table class="table mb-0" id="frmPrint">
                        ...
                        <tr>
                            <td colspan="2">
                                <button type="submit" class="btn btn-success"><spring:message code='button.approve.title'/></button>
                                <a href="${_ctx}/approval/translate/confirm/reject.hs?approvalId=${form.approvalId}" class="btn btn-danger"><spring:message code='button.reject.title'/></a>
        ...
        <div class="col-xl-4 ui-sortable">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    <h3 class="panel-title"><spring:message code='approval.tab.translate.history.title'/></h3>
                </div>
                <div class="panel-body">
                    <table class="table table-bordered mt-2 mb-0">
                        <thead>
                        ...
                        <tbody>
                            <c:if test="${translateHistory.size() > 0}">
                                <c:forEach items="${translateHistory}" var="lst" varStatus="loop">                                       
                                    <tr>
                                        <td>${loop.index + 1}</td>
                                        <td>${lst.empName}</td>
                                        <td>${lst.regDt}</td>
