...
<div id="content" class="content">
    <h3 class="page-title">
        <spring:message code='approval.page.draft.title'/><br>
    ...
    <div class="row">
        <div class="col-xl-12 ui-sortable">
            ...
            <div class="panel panel-inverse" style="">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <spring:message code="common.list.title"/>
                    </h3>
                </div>
                <div class="panel-body">
                        ...
                        <tbody>
                            ...
                            <c:forEach items="${list}" var="item" varStatus="loop">
                                <tr>
                                    ...
                                    <td><a href="${_ctx}/approval/draft/update.hs?approvalId=${item.approvalId}" class="btn btn-primary"><i class="fas fa-file-signature"></i></a></td>
                                </tr>
                            </c:forEach>
                            </c:if>
                            <c:if test="${list.size() == 0}">
                                <tr><td colspan="12"><spring:message code="main.index.datastatus" /></td></tr>
                            </c:if>
                        </tbody>
                    </table>
                    <div>
