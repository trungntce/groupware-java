...
<div id="content" class="content">
    ...
    <h1 class="page-header cursor-default">
        <spring:message code='dateboard.notice.company.nhom' /> - <spring:message code='dateboard.notice.company.add' />
        <br>
        ...
        <div class="col-xl-12">
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <form:form modelAttribute="board" action="${_ctx}/board/notice/group/write.hs" method="post" cssClass="form-inline">
                        <table class="table mb-0">
                            <tr>
                                <td style="background: #f0f4f6; width: 100px;"><spring:message code='dateboard.notice.company.boardtype' /></td>
                                <td><p>Group</p></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><form:input path="title" cssClass="title-board form-control form-control-sm mr-1" /></td>
                            </tr>
                            <tr>
                            ...
                            <tr id="controlDate" hidden>
                                <td style="background: #f0f4f6;"><spring:message code='dateboard.notice.company.starttime' /></td>
                                <td><form:input type="text" value="" readonly="true" path="notiStartDt" cssClass="form-control form-control-sm mr-1" /></td>
                            </tr>
                            <tr>
                                <td style="background: #f0f4f6;"><spring:message code='dateboard.notice.company.endtime' /></td>
                                <td>
                                    <form:input type="text" value="" readonly="true" path="notiEndDt" cssClass="form-control form-control-sm mr-1 w-75 float-left" />
    ...
    <div>
        ...
        <button class="btn btn-primary float-right" onclick="addNewRow()"><spring:message code='button.rowadd' /></button>
    </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $(".go_list_btn").click(function () {
            location.href = "/board/notice/group/list.hs";
        });
