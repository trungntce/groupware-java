    ...
    var urls="/board/notice/group/";
        ...
        <div id="content" class="content">
            ...
            <h1 class="page-header cursor-default">
                <spring:message code='dateboard.notice.company.list' />  - <spring:message code='dateboard.notice.company.edit' />
                <br>
                ...
                <div class="col-xl-12">
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                            <form:form modelAttribute="board" action="${_ctx}/board/notice/free/edit.hs" method="post" cssClass="form-inline">
                                <table class="table mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <td><spring:message code='dateboard.notice.company.list' /></td>
                                    </tr>
                                    <tr>
            ...
            <div>
                ...
                <button style="margin-bottom: 5px;float: right" class="btn btn-primary" onclick="addNewRow()"><spring:message code='button.rowadd' /></button>
            </div>
...
<script type="text/javascript">
    ...
    $('#notiEndDt').datepicker({
        ...
        $(".go_list_btn").click(function () {
            location.href = "/board/notice/free/list.hs?<%=backSearch%>";
        });
