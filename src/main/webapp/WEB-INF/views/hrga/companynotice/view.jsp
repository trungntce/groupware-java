    ...
    %>
        <div id="content" class="content">
            <h1 class="page-header cursor-default">
                <spring:message code='dateboard.notice.company.list'/> - <spring:message code='author.list.bigtitle'/>
                <br>
                <small>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $("#go_edit_btn").click(function () {
                    ...
                    location.href = "/board/notice/free/edit.hs?boardId=" + boardId+"&<%=backSearch%>";
                });
            ...
            function delTran(id) {
                $.ajax({
                    ...
                    success: function (response) {
                        location.href = "/board/notice/free/view.hs?boardId=${boardDTO.boardId}&<%=backSearch%>";
                    },
            ...
            function addtran(id) {
                location.href = "/board/notice/free/addTran.hs?id=" + id + "&loai=fboardtrans&type=free&<%=backSearch%>";
            }
            function editTrans(id, dw) {
                location.href = "/board/notice/free/edittrans.hs?transId=" + id + "&boardid=" + dw + "&loai=free&<%=backSearch%>";
            }
            function back() {
