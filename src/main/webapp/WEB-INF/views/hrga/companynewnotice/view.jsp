...
<div id="content" class="content">
    <h1 class="page-header cursor-default">
        <spring:message code='dateboard.notice.company.cty' /> - <spring:message code='author.list.bigtitle'/>
        <br>
                ...
                <div class="panel-body">
                    <table class="table mb-0">
                        ...
                        <tr>
                            ...
                            <td>
                                <div id="aTran">
                                    <table id="tbTran" class="table mb-auto text-center">
                                        <thead>
                                            <tr>
                                                ...
                                                <c:otherwise>
                                                    <c:forEach items="${detailTran}" var="ltk">
                                                        <tr>
                                                            ...
                                                            <td>${ltk.regDt}</td>
                                                            <td>
                                                                <button type="button" class="btn btn-danger" onclick="editTrans('${ltk.translationId}','${boardDTO.boardId}')">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $("#go_edit_btn").click(function () {
                    ...
                    location.href = "/board/notice/company/edit.hs?boardId=" + boardId+"&<%=backSearch%>";
                });
            ...
            function delTran(id) {
                $.ajax({
                    ...
                    success: function (response) {
                        location.href = "/board/notice/company/view.hs?boardId=${boardDTO.boardId}&<%=backSearch%>";
                    },
            ...
            function addtran(id) {
                location.href = "/board/notice/company/addTran.hs?id=" + id + "&loai=cboardtrans&type=company&<%=backSearch%>";
            }

            function editTrans(id, dw) {
                location.href = "/board/notice/company/edittrans.hs?transId=" + id + "&boardid=" + dw + "&loai=company&<%=backSearch%>";
            }
