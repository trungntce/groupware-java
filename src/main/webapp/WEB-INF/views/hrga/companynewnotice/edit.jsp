...
<div id="content" class="content">
    ...
    <h1 class="page-header cursor-default">
        <spring:message code='dateboard.notice.company.cty' />  - <spring:message code='dateboard.notice.company.edit' />
        <br>
        <small><spring:message code='detail.edit' /></small>
    </h1>

    <div class="text-right pb-2">
        <button type="button" class="btn btn-purple do_update_btn" board-id="${boardDTO.boardId}"><spring:message code='dateboard.notice.company.edit' /></button>
        ...
        <div class="col-xl-12">
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <form:form modelAttribute="board" action="${_ctx}/board/notice/company/edit.hs"
                        method="post" cssClass="form-inline">
                        <table class="table mb-0">

                            <form:hidden path="boardId" value="${boardDTO.boardId}" />
                            <tr>
                                <td style="background: #f0f4f6;"><span style="color:red;">*</span><spring:message code='dateboard.notice.company.boardtype' /></td>
                                <td><spring:message code='dateboard.notice.company.cty' /> </td>
                            </tr>
                            <tr>
                            ...
                            <tr id="controlDate">
                                ...
                                <td><form:input type="text" readonly="true" value="${boardDTO.notiStartDt.split(' ')[0]}" path="notiStartDt" cssClass="form-control form-control-sm mr-1" /></td>
                            </tr>
                            <tr>
                                <td style="background: #f0f4f6;"><spring:message code='dateboard.notice.company.endtime' /></td> <!-- notification time end -->
                                <td><form:input type="text" readonly="true" value="${boardDTO.notiEndDt.split(' ')[0]}" path="notiEndDt" cssClass="form-control form-control-sm mr-1" /></td>
                            </tr>

                            <!-- contents -->
                            <tr>
                                <td style="background: #f0f4f6;"><spring:message code='dateboard.notice.company.contents' /></td>
                                <td colspan="3"><textarea id="contents" name="contents" class="ckeditor form-control" rows="5" cols="80" style="width:100%">${boardDTO.contents}</textarea></td>
                            </tr>
    ...
    <div>
        <h1 class="page-title text-left"><small><spring:message code='file.attach' /></small></h1>
        <button class="btn btn-primary float-right mb-2" onclick="addNewRow()"><spring:message code='button.rowadd' /></button>
    </div>
...
<script>
    $(document).ready(function () {
        ...
        $(".go_list_btn").click(function () {
            location.href = "/board/notice/company/list.hs?<%=backSearch%>";
        });
