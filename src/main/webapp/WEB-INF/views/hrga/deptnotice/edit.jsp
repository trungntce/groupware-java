...
<div id="content" class="content">
    ...
    <h1 class="page-header cursor-default">
        <spring:message code='dateboard.notice.company.phong'/> - <spring:message code='dateboard.notice.company.edit' />
        <br>
        ...
        <div class="col-xl-12">
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <form:form modelAttribute="board" action="${_ctx}/board/notice/department/edit.hs" method="post" cssClass="form-inline">
                        <table class="table mb-0">
                            ...
                            <tr>
                                ...
                                <td><spring:message code='dateboard.notice.company.phong'/></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><textarea id="contents" name="contents" class="ckeditor form-control w-100" rows="5" cols="80">${boardDTO.contents}</textarea></td>
                            </tr>
