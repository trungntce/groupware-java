    ...
    var urls="/board/notice/group/";
        ...
        <div id="content" class="content">
            ...
            <h1 class="page-header cursor-default">
                <spring:message code='dateboard.notice.company.phong' /> - <spring:message code='dateboard.notice.company.add' />
                <br>
                <small>
                ...
                <div class="col-xl-12">
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                            <form:form modelAttribute="board" action="${_ctx}/board/notice/department/write.hs"
                                        ...
                                        <td>
                                            <c:if test="${rules <= 7}">
                                                <form:select path="deptCd"
                                                    ...
                                                    <form:options items="${selectDepartmentList}" itemValue="deptCd"
                                                        itemLabel="deptName" />
                                                </form:select>
                                            </c:if>
                                            <c:if test="${rules > 7}">
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $(".go_list_btn").click(function () {
                    location.href = "/board/notice/department/list.hs";
                });
