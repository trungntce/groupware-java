                    ...
                    <% DateTimeFormatter dtf=DateTimeFormatter.ofPattern("yyyy-MM-dd"); LocalDateTime
                        ...
                        <% String start_date=request.getParameter("start_date"); if (start_date==null ||
                                        ...
                                        <h4 class="panel-title">
                                            ...
                                            <c:choose>
                                                <c:when test="${statusEdit==1}">
                                                    <button type="button" class="btn btn-purple" <%=disable%> onclick="editW()">
                                                        <spring:message code='work.detail.edit' />
                                                    </button>
                                                    <button type="button" class="btn btn-primary" <%=disable%> onclick="addmore()">
                                    ...
                                    <div class="col-xl-12">
                                        <div class="panel panel-inverse">
                                            ...
                                            <div class="panel-body">
                                                <table class="table mb-0" style="word-break: break-all;">
                                                    <tr>
                                                        ...
                                                        <td style="width: calc(100% - 90px);">${detailDTO.empName}</td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <table id="content-main" class="table mb-auto text-center" style="word-break: break-all;">
                                                                <thead>
                                                                    <tr>
                                                                ...
                                                                <tbody>
                                                                    <c:forEach items="${workChild}" var="lst">
                                                                        <tr id="row-${lst.id}" style="height: 66px;">
                                                                            <td style="vertical-align: inherit;"><div class="content-main-daywork">${lst.contents}</div></td>
                                                                            ...
                                                                            <c:choose>
                                                                                <c:when
                                                                                    ...
                                                                                    <td style="text-align: center; vertical-align: inherit;">
                                                                                        <input id="${lst.id}_NOTYET" class="${lst.id}_check" type="checkbox" <%=disable%> ${styleDisble} name="ndaddPeing" value="NOTYET">
                                                                                    </td>
                                                                                    <td style="text-align: center; vertical-align: inherit;">
                                                                                        <input id="${lst.id}_WORKING" class="${lst.id}_check" type="checkbox" <%=disable%> ${styleDisble} checked="" name="addDoing" value="WORKING">
                                                                                    </td>

                                                                                    <td style="text-align: center; vertical-align: inherit;">
                                                                                        <input id="${lst.id}_FINISH" class="${lst.id}_check" type="checkbox" <%=disable%> ${styleDisble} name="addFinish" value="FINISH">
                                                                                    </td>
                                                                                </c:when>
                                                                                <c:when test="${lst.workStatus=='NOTYET'}">
                                                                                    <td style="text-align: center; vertical-align: inherit;">
                                                                                        <input id="${lst.id}_NOTYET" class="${lst.id}_check" type="checkbox" <%=disable%> ${styleDisble} checked="" name="addPending" value="NOTYET">
                                                                                    </td>
                                                                                    <td style="text-align: center; vertical-align: inherit;">
                                                                                        <input id="${lst.id}_WORKING" class="${lst.id}_check" type="checkbox" <%=disable%> ${styleDisble} name="addDoing" value="WORKING">
                                                                                    </td>

                                                                                    <td style="text-align: center; vertical-align: inherit;">
                                                                                        <input id="${lst.id}_FINISH" class="${lst.id}_check" type="checkbox" <%=disable%>
                                                                                        ${styleDisble}
                                                                                        name="addFinish"
                                                                                        value="FINISH">
                                                                                    </td>
                                                                                ...
                                                                                <c:otherwise>
                                                                                    <td style="text-align: center; vertical-align: inherit;">
                                                                                        <input id="${lst.id}_NOTYET" class="${lst.id}_check" type="checkbox" <%=disable%>
                                                                                        ${styleDisble}
                                                                                        name="addPending"
                                                                                        value="NOTYET">
                                                                                    </td>
                                                                                    <td style="text-align: center; vertical-align: inherit;">
                                                                                        <input id="${lst.id}_WORKING" class="${lst.id}_check" type="checkbox" <%=disable%>
                                                                                        ${styleDisble}
                                                                                        name="addDoing"
                                                                                        value="WORKING">
                                                                                    </td>
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${countCheck == 2}">
                                                            <c:choose>
                                                                <c:when test="${statusEdit==1}">
                                                                    <tr>
                                                                        <td style="background: #f0f4f6; vertical-align: inherit;">
                                                                            <spring:message code='work.detail.workfunction' />
                                                                        </td>
                                                                        <td>
                                                                            <div class="function-childrent" style="float: left;width: 100%;">
                                                                                <div style="float: right;">
                                                                                    <button type="button" class="btn btn-purple" <%=disable%> onclick="editmore()">
                                                                                        <spring:message code='work.detail.edit' />
                                                                                    </button>
                                                                                </div>
                                                                            </div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <table id="content-main" class="table mb-auto"style="word-break: break-all;">
                                                                        <thead>
                                                                            <tr>
                                                                                <th style="text-align: center; width: 700px;"><spring:message code='work.detail.contents' /></th>
                                                                                <th style="width: 160px;text-align: center;"><spring:message code='work.detail.datecreate' /></th>
                                                                                <th style="width: 160px;text-align: center;"><spring:message code='work.detail.modifydate' /></th>
                                                                                <th style="width: 8%;text-align: center;"><spring:message code='work.list.pedding' /></th>
                                                                                <th style="width: 8%;text-align: center;"><spring:message code='work.list.doing' /></th>
                                                                                <th style="width: 8%;text-align: center;"><spring:message code='work.list.finish' /></th>
                                                                            </tr>
                                                                        </thead>

                                                                        <tbody>
                                                                            <c:forEach items="${workMoreChild}"
                                                                                var="lst">
                                                                                <tr id="row-${lst.id}" style=" height: 66px;">
                                                                                    <td style="vertical-align: inherit;"><div class="content-main-daywork">${lst.contents}</div></td>
                                                                                    <td style="vertical-align: inherit; text-align: center;">${lst.createDate}</td>
                                                                                    ...
                                                                                    <c:choose>
                                                                                        <c:when
                                                                                            ...
                                                                                            <td style="text-align: center; vertical-align: inherit;">
                                                                                                <input id="${lst.id}_WORKING" class="${lst.id}_check" type="checkbox" <%=disable%> ${styleDisble} checked="" name="addDoing"
                                                                                                value="WORKING">
                                                                                            </td>
                                                                                        ...
                                                                                        <c:when
                                                                                            ...
                                                                                            <td style="text-align: center; vertical-align: inherit;">
                                                                                                <input id="${lst.id}_NOTYET" class="${lst.id}_check" type="checkbox" <%=disable%> ${styleDisble} checked="" name="addPending"
                                                                                                value="NOTYET">
                                                                                            </td>
                                                                                            <td style="text-align: center; vertical-align: inherit;">
                                                                                                <input id="${lst.id}_WORKING" class="${lst.id}_check" type="checkbox" <%=disable%> ${styleDisble} name="addDoing" value="WORKING">
                                                                                        ...
                                                                                        <c:otherwise>
                                                                                            <td style="text-align: center; vertical-align: inherit;">
                                                                                                <input id="${lst.id}_NOTYET" class="${lst.id}_check" type="checkbox" <%=disable%> ${styleDisble} name="addPending" value="NOTYET">
                                                                                            </td>
                                                                                            <td style="text-align: center; vertical-align: inherit;">
                                                                                                <input id="${lst.id}_WORKING" class="${lst.id}_check" type="checkbox" <%=disable%> ${styleDisble} name="addDoing" value="WORKING">
                                                                                            </td>
                                                                                            ...
                                                                                            <td style="text-align: center; vertical-align: inherit;">
                                                                                                <input id="${lst.id}_FINISH" class="${lst.id}_check" type="checkbox" <%=disable%> ${styleDisble} name="addFinish" checked="" value="FINISH">
                                                                                            </td>
                                                                                        </c:otherwise>
                                                                                    </c:choose>
                                                                                </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="vertical-align: inherit;">
                                                            <button type="button" class="btn btn-primary" <%=disable%> onclick="addtran('${detailDTO.dayWorkId}')">
                                                    ...
                                                    <tr>
                                                        <td style="background: #f0f4f6;font-weight: bold; vertical-align: inherit;">
                                                            <spring:message code='work.detail.translation' />
                                                        </td>
                                                        <td style="vertical-align: inherit;">
                                                            <div id="aTran">
                                                                <table id="tbTran" class="table mb-auto" style="word-break: break-all;">
                                                                    <thead>
                                                                        <tr>
                                                                    ...
                                                                    <tbody>
                                                                        <c:forEach items="${detailTran}" var="ltk">
                                                                            <tr>
                                                                                ...
                                                                                <td style="vertical-align: inherit;">
                                                                                    <div class="content-main-daywork">
                                                                                        ${ltk.contents}
                                                                                    </div>
                                                                                </td>
                                                                                <td style="vertical-align: inherit;">${ltk.regDt}</td>
                                                                                <td style="vertical-align: inherit;">
                                                                                    <input class="toggle-group" name="checkboxStatus" id="status_${ltk.translationId}" value="${ltk.translationId}" type="checkbox" ${disabled} ${ltk.translationStatus=="1" ?"checked":"" } data-toggle="toggle" data-on="<spring:message code='work.detail.button.translate.finish'/>" data-off=" <spring:message code='work.detail.button.translate.notfinish' />" data-onstyle="success" data-offstyle="danger">
                                                                                </td>
                                                                                <c:if test="${empCd eq ltk.empCd}">
                                                                                    <td style="vertical-align: inherit;">
                                                                                        <button type="button" value="" style="width: 80px; text-align: center;" class="btn btn-danger" onclick="editTrans('${ltk.translationId}','${detailDTO.dayWorkId}')"><spring:message code='work.detail.edit'/></button>
                                                                                    </td>
                                                                                    <td style="vertical-align: inherit;">
                                                                                        <button type="button" value="" class="btn btn-danger" onclick="delTran('${ltk.translationId}')"><spring:message code='work.detail.delete'/></button>
                                                                                    </td>
                                                                                </c:if>
                                                                                <c:if test="${empCd != ltk.empCd}">
                                                                                    <td
                                                                                        ...
                                                                                        <button type="button" value=""
                                                                                            ...
                                                                                            disabled
                                                                                            onclick="editTrans('${ltk.translationId}','${detailDTO.dayWorkId}')">
                                                                                            <spring:message code='work.detail.edit' />
                                                                                        </button>
                                                                                    </td>
                                                                                    <td style="vertical-align: inherit;">
                                                                                        <button type="button" value="" class="btn btn-danger" disabled onclick="delTran('${ltk.translationId}')">
                                                    ...
                                                    <c:choose>
                                                        <c:when test='${positionEmp<8 || empDTO.adminYn == "Y"}'>
                                                            <tr>
                                                                <td style="background: #f0f4f6; vertical-align: inherit;">
                                                                    <spring:message code='work.detail.commentfunction' />
                                                                </td>
                                                                <td style="vertical-align: inherit;">
                                                    ...
                                                    <tr>
                                                        <td style="background: #f0f4f6;font-weight: bold;  vertical-align: inherit;">
                                                            <spring:message code='work.detail.messa' />
                                                        </td>
                                                        <td>
                                                            <div id="aComment">
                                                                <table id="tbComment" class="table mb-auto" style="word-break: break-all;">
                                                                    <thead>
                                                                        <tr>
                                                                            <th class="all"><spring:message code='work.detail.stt' /></th>
                                                                            <th class="min-tablet"><spring:message code='work.detail.language' /></th>
                                                                            <th class=""><spring:message code='work.detail.empName' /></th>
                                                                            <th class=""><spring:message code='work.detail.contents' /></th>
                                                                            <th class="min-tablet"><spring:message code='work.detail.registerDate' /></th>
                                                                            ...
                                                                            <c:otherwise>
                                                                                <c:forEach items="${detailCMT}" var="ltk">
                                                                                    <tr>
                                                                                        ...
                                                                                        <td style="vertical-align: inherit;">${ltk.regDt}</td>
                                                                                        <td style="width: 10%; text-align: center; vertical-align: inherit;">
                                                                                            <button type="button" style="width: 100px; text-align: center;" class="btn btn-primary open_slide_btn">
                                                                                                <spring:message code='work.detail.show' />
                                                                                            </button>
                                                                                            <button type="button" class="btn btn-primary close_slide_btn" style="display: none; width: 100px; text-align: center;">
                                                                                                <spring:message code='work.detail.hide' />
                                                                                            </button>
                                                                                        </td>
                                                                                        <td style="width: 10%; text-align: center; vertical-align: inherit;">
                                                                                            <button type="button" value="" style="width: 130px; text-align: center;" class="btn btn-danger" onclick="addCmtTrans('${ltk.dayWorkCommentId}','${detailDTO.dayWorkId}')">
                                                                                                <spring:message code='work.detail.addTran' />
                                                                                            </button>
                                                                                        </td>
                                                                                        <c:if test="${empCd == ltk.empCd}">
                                                                                            <td style="width: 10%; text-align: center; vertical-align: inherit;">
                                                                                                <button type="button" value="" style="width: 80px; text-align: center;" class="btn btn-danger" onclick="editComment('${ltk.dayWorkCommentId}','${detailDTO.dayWorkId}')">
                                                                                                    <spring:message code='work.detail.edit' />
                                                                                                </button>
                                                                                            </td>
                                                                                        </c:if>
                                                                                        <c:if test="${empCd != ltk.empCd}">
                                                                                            <td style="width: 10%; text-align: center; vertical-align: inherit;">
                                                                                                <button type="button" value="" style="width: 80px; text-align: center;" class="btn btn-danger" disabled onclick="editComment('${ltk.dayWorkCommentId}','${detailDTO.dayWorkId}')">
                                                                                                    <spring:message code='work.detail.edit' />
                                                                                                </button>
                                                                                            </td>
                                                                                        </c:if>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-primary" onclick="addCo()">Add</button>
                            ...
                            <script type="text/javascript">
                                ...
                                function addtran(id) {
                                    location.href = "/work/daywork/addTran.hs?id=" + id + "&loai=daywork&<%=backSearch%>";
                                }
                                ...
                                function delTran(id) {
                                    $.ajax({
                                        ...
                                        success: function (response) {
                                            location.href = "/work/daywork/detail.hs?id=${detailDTO.dayWorkId}&title=success&message=Delete sucess&<%=backSearch%>";
                                        },
                                        error: function (error) {
                                            toastr['error']('error !');
                                        }
                                ...
                                function editW() {
                                    location.href = "/work/daywork/edit.hs?dayWorkId=${detailDTO.dayWorkId}&type=main" + "&<%=backSearch%>";
                                }


                                function editmore() {
                                    location.href = "/work/daywork/editmore.hs?dayWorkId=${detailDTO.dayWorkId}&type=sub&<%=backSearch%>";
                                }

                                function addmore() {
                                    location.href = "/work/daywork/addmore.hs?dayWorkId=${detailDTO.dayWorkId}" + "&loai=daywork&<%=backSearch%>";
                                }

                                function editComment(id, dw) {
                                    location.href = "/work/daywork/editcomment.hs?dayWorkCommentId=" + id + "&dayWorkId=" + dw + "&loai=daywork&<%=backSearch%>";
                                }

                                function back() {
                                    location.href = "/work/daywork/list.hs?<%=backSearch%>";
                                }

                                function editTrans(id, dw) {
                                    location.href = "/work/daywork/edittrans.hs?transId=" + id + "&dayWorkId=" + dw + "&loai=daywork&<%=backSearch%>";
                                }

                                function addcomment(id) {
                                    location.href = "/work/daywork/addcomment.hs?id=" + id + "&loai=daywork&<%=backSearch%>";
                                }

                                function addCmtTrans(id, dw) {
                                    location.href = "/work/daywork/addcomttrans.hs?id=" + id + "&loai=daywork&dayworkid=" + dw + "&<%=backSearch%>";
                                }
