                                            ...
                                            <td style="width: 100%">
                                                <table>
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <input id="idcontent1" name="contents"
                                                        ...
                                                        <tr id="idTrContent2">
                                                            <td>
                                                                <input id="idcontent2" name="contents"
                                                                    style=" height: 38px; font-size: 17px;width: 600px;"
                                                                    class="form-control form-control-sm mr-1"
                                                                    type="text" value="">
                                                            </td>
                                                        ...
                                                        <tr id="idTrContent3">
                                                            <td>
                                                                <input id="idcontent3" name="contents"
                                                                    style=" height: 38px; font-size: 17px;width: 600px;"
                                                                    class="form-control form-control-sm mr-1"
                                                                    type="text" value="">
                                                            </td>
            ...
            function goEvent() {
                ...
                if (isValid == true) {
                    ...
                    $.ajax(settings).done(function (response) {
                        location.href = "/work/daywork/detail.hs?id=${daywork}&<%=backSearch%>";
                        off();
                    });
                }else{
                    off();
