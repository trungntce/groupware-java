                ...
                <div class="col-xl-12 ui-sortable">
                    ...
                    <div class="panel panel-inverse" style="">
                        ...
                        <div class="panel-body">
                            <form id="myform1" class="form-inline" action="" method="post">
            ...
            function add() {
                ...
                if (isValid == true) {
                    ...
                    $.ajax(settings).done(function (response) {
                        if (response == "a") {
                            location.href = "/work/${loai}/detail.hs?id=${dayworkid}&title=success&message=Add new sucess&<%=backSearch%>";
                            off();
                        } else {
                            location.href = "/work/${loai}/detail.hs?id=${dayworkid}&title=error&message=error&<%=backSearch%>";
                            off();
                        }
                    });
                }else{
