                                    ...
                                    <tbody>
                                        ...
                                        <c:choose>
                                            <c:when test="${countCheck == 2}">
                                                <td style="background: #f0f4f6;"><spring:message code='work.detail.addmorecontents' /></td>
                                                <td>${childContents}</td>
                                            </c:when>
                                        </c:choose>
                                    </tbody>
                                ...
                                <table class="table mb-0">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select id="language" name="language" class="custom-select custom-select-sm form-control form-control-sm w-100 mr-1">
                                        ...
                                        <tr>
                                            ...
                                            <td><input id="title" name="title" maxlength="200" class="form-control form-control-sm w-100 mr-1" type="text" value=""></td>
                                        </tr>
                                        <tr>
                                            <td style="background: #f0f4f6;"><spring:message code='work.addtran.contents' /></td>
                                            <td><textarea id="contents" name="contents" class="ckeditor form-control" style="width:100%" rows="2" cols="80"></textarea></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </form>
