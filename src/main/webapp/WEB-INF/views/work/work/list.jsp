...
<div id="content" class="content">
    <h1 class="page-header cursor-default">
        <spring:message code='main.index.work'/> - <spring:message code='tieude.workbig'/>
        <br>
        <small>
            <spring:message code='tieude.worksmall'/>
        </small>
    </h1>
    ...
    <div class="m-table" style="position: relative;">
        <table id="tbwork" class="table table-striped table-bordered" style="width:100%;text-align: center">
            <thead>
...
<script>
    ...
    $(document).ready(function () {
        ...
        var table = $('#tbwork').DataTable({
            ...
            "sAjaxSource": "/springPaginationDataTablesWork?start_date=" + $('#start_date').val() + "&end_date=" + $('#end_date').val() + "&levelDept=" + $("#levelDept").val() + "&translationStatus=" + $('#translationStatus').val() + "&workStatus=" + $('#workStatus').val() + "&optionSearch=" + $('#optionSearch').val() + "&inputSearch=" + $('#inputSearch').val(),
            "columns": [
                {
                    "data": "workId",
        ...
        $('#tbwork').on( 'page.dt', function () {
            ...
            location.href = "/work/work/list.hs?start_date=" + $('#start_date').val() + "&end_date=" + $('#end_date').val() + "&levelDept=" + $("#levelDept").val() + "&translationStatus=" + $('#translationStatus').val() + "&workStatus=" + $('#workStatus').val() + "&optionSearch=" + $('#optionSearch').val() + "&inputSearch=" + $('#inputSearch').val() + "&displayStartPra=" + displayStartPra;
        } );
    ...
    function detail(id) {
        var displayStartPra = $('#tbwork').DataTable().page.info().page * 10;
        location.href = "/work/work/detail.hs?id=" + id + "&start_date=" + $('#start_date').val() + "&end_date=" + $('#end_date').val() + "&levelDept=" + $("#levelDept").val() + "&translationStatus=" + $('#translationStatus').val() + "&workStatus=" + $('#workStatus').val() + "&optionSearch=" + $('#optionSearch').val() + "&inputSearch=" + $('#inputSearch').val() + "&displayStartPra=" + displayStartPra;
    }

    function addW() {
        location.href = "/work/work/addW.hs";
    }
        ...
        if (lstChecked.trim() == "") {
            ...
            $.ajax({
                ...
                success: function (response) {
                    location.href = "/work/work/list.hs?title=success&message=Delete sucess";
                },
    ...
    function searchMethod() {
        // $('#tbwork').DataTable().ajax.url("/springPaginationDataTablesWork?start_date=" + $('#start_date').val() + "&end_date=" + $('#end_date').val() + "&levelDept=" + $("#levelDept").val() + "&translationStatus=" + $('#translationStatus').val() + "&workStatus=" + $('#workStatus').val() + "&optionSearch=" + $('#optionSearch').val() + "&inputSearch=" + $('#inputSearch').val()).load();
