...
%>
                                ...
                                <table class="table mb-0 w-100">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input id="title" name="title" class="form-control form-control-sm w-100 mr-1" type="text" value="${workDTO.title}"></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><textarea id="contents" name="contents" class="ckeditor form-control w-100" rows="2">${workDTO.contents}</textarea></td>
                                        </tr>
                                        <tr>
                                            <td style="background: #f0f4f6"><spring:message code='work.add.important' /></td>
                                            <td><input style="margin-left: 5px" class="form-check-input" type="checkbox" id="important" name="important" ${workDTO.importantYn=="Y" ? "checked" : "" }></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div style="float: left;">
                                                    ...
                                                    <input readonly id="workstart" name="workstart" class="form-control form-control-sm mr-1" type="text" value="${workDTO.workStartDt}">
                                                </div>
                                                <div style="float: left;margin-left: 20px">
                                                    <span>
                                                        <spring:message code='work.add.end' />:
                                                    </span>
                                                    <input readonly id="workend" name="workend" class="form-control form-control-sm mr-1" type="text" value="${workDTO.workEndDt}">
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
        ...
        <script>
            ...
            function EditW() {
                ...
                if (isValid == true) {
                    ...
                    $.ajax(settings).done(function (response) {
                        location.href = "/work/work/detail.hs?id=${workDTO.workId}&title=success&message=Edit sucess&<%=backSearch%>";
                        off();
                    });
            ...
            function back() {
                location.href = "/work/work/detail.hs?id=${workDTO.workId}&<%=backSearch%>";
            }
