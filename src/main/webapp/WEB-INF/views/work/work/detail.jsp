                    ...
                    <div>
                        ...
                        <div style="float: right">
                            <h4 class="panel-title">
                                <button type="button" class="btn btn-purple" onclick="editW()">
                        ...
                        <div class="col-xl-12">
                            <div class="panel panel-inverse">
                                <div class="panel-heading">
                                    <h4 class="panel-title"><spring:message code='work.detail.information' /></h4>
                                </div>

                                <div class="panel-body">
                                    <table class="table mb-0">
                                        <tr>
                                            <td style="background: #f0f4f6; min-width: 90px; max-width: 90px;"><spring:message code='work.detail.empName' /></td>
                                                        ...
                                                        <tbody>
                                                            <c:forEach items="${detailTran}" var="ltk">
                                                                <tr>
                                                                    ...
                                                                    <td>${ltk.regDt}</td>
                                                                    <td>
                                                                        <input id="status_${ltk.translationId}" type="checkbox" ${ltk.translationStatus=="1" ?"checked":"" } data-toggle="toggle" data-on="<spring:message code='work.detail.button.translate.finish'/>" data-off="<spring:message code='work.detail.button.translate.notfinish'/>" data-onstyle="success" data-offstyle="danger">
                                                                    </td>

                                                                    <c:choose>
                                                                        <c:when test='${empDTO.empCd == ltk.empCd}'>
                                                                            <td>
                                                                                <button type="button" class="btn btn-danger text-center" onclick="editTrans('${ltk.translationId}','${detailDTO.workId}')"><spring:message code='work.detail.edit' />
                                                                                </button>
                                                                            </td>
                                                                            <td>
                                                                        ...
                                                                        <c:otherwise>
                                                                            <td><button type="button" class="btn btn-danger" disabled><spring:message code='work.detail.edit' /></button></td>
                                                                            <td><button type="button" disabled class="btn btn-danger"><spring:message code='work.detail.delete' /></button></td>
                                                                        </c:otherwise>
                                                                    </c:choose>
                                                                </tr>
                                                            </c:forEach>
                                                    ...
                                                    <table id="tbCo" class="table mb-auto">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th><spring:message code='work.detail.empName' /></th>
                                                                <th><spring:message code='work.detail.dept' /></th>
                                                                <th><spring:message code='work.detail.position' /></th>
                                                                <th><spring:message code='work.detail.registerDate' /></th>
                                                                <th><spring:message code='work.detail.approve' /></th>
                                                                <th><spring:message code='work.detail.datecheck' /></th>
                                                             </tr>
                                                        </thead>
                                                        <tbody>
                                                            ...
                                                            <td>
                                                                <c:choose>
                                                                    <c:when test="${lco.empCd == empGui}">
                                                                        <input id="approve_${lco.workCooperationId}"
                                                                            type="checkbox" ${lco.workCheckYn=="Y" ?"checked":""
                                                                            } data-toggle="toggle"
                                                                            data-on="<spring:message code='work.detail.approve'/>"
                                                                            data-off="<spring:message code='work.detail.notyet'/>"
...
<%--                                            end o day--%>
                                        ...
                                        <div id="song">
                                            <div class="choices" data-type="select-multiple" role="combobox"
                                                ...
                                                <div class="choices__inner">
                                                    <select id="choices-multiple-remove-button" placeholder="Select upto 5 tags" multiple="" class="choices__input is-hidden" tabindex="-1" aria-hidden="true" data-choice="active"></select>
                                                    <div class="choices__list choices__list--multiple"></div>
                                                    <input type="text" class="choices__input choices__input--cloned" autocomplete="off" autocapitalize="off" spellcheck="false" role="textbox" aria-autocomplete="list" placeholder="Select..." style="width: 100px;">
                                                </div>
                ...
                <script type="text/javascript">
                    ...
                    function addtran(id) {
                        location.href = "/work/work/addTran.hs?id=" + id + "&loai=work&<%=backSearch%>";
                    }

                    function back() {
                        location.href = "/work/work/list.hs?<%=backSearch%>";
                    }

                    function addCo() {
                        on();
                        //them vao database
                        var mang = $('#choices-multiple-remove-button').val();
                        var lstCo = "";
                        for (var k = 0; k < mang.length; k++) {
                            lstCo += mang[k] + ",";
                        }
                        ...
                        $.ajax({
                            ...
                            data: {
                                lstCo: lstCo,
                                workId: '${ detailDTO.workId }'
                            },
                            success: function (response) {
                                location.href = "/work/work/detail.hs?id=${detailDTO.workId}&title=success&message=sucess&<%=backSearch%>";
                                off();
                            },
                            error: function (error) {
                                toastr['error']('error !');
                    ...
                    function xoaCo(id) {
                        $.ajax({
                            ...
                            success: function (response) {
                                location.href = "/work/work/detail.hs?id=${detailDTO.workId}&title=success&message=Delete sucess&<%=backSearch%>";
                                off();
                            },
                            error: function (error) {
                                toastr['error']('error !');
                    ...
                    function editTrans(id, dw) {
                        location.href = "/work/work/editworktrans.hs?transId=" + id + "&WorkId=" + dw + "&loai=work&<%=backSearch%>";
                    }

                    function editW() {
                        location.href = "/work/work/editW.hs?workId=${detailDTO.workId}&<%=backSearch%>";
                    }
