<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ include file="/WEB-INF/layout/common/commonTags.jspf" %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div style="float: left;">
                                                    ...
                                                    <input readonly id="workstart" name="workstart" class="form-control form-control-sm mr-1" type="text">
                                                </div>
                                                <div style="float: left;margin-left: 20px">
                                                    <span><spring:message code='work.add.end' />:</span>
                                                    <input readonly id="workend" name="workend" class="form-control form-control-sm mr-1" type="text">
        ...
        <script>
            ...
            function addW() {
                ...
                if (isValid == true) {
                    ...
                    $.ajax(settings).done(function (response) {
                        off();
                        location.href = "/work/mywork/list.hs?title=success&message=Add new sucess";
                    });
            ...
            function back() {
                location.href = "/work/mywork/list.hs";
            }
